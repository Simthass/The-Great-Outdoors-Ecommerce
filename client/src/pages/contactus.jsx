...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setStatus({ message: data.message || "Message sent successfully!", error: false });
    } catch (err) {
      setStatus({ message: err.message || "Failed to send message", error: true });
    } finally {
      setSubmitting(false);
    }
  };
        ...
        <div style={{ 
          ...
          <div style={{ marginBottom: "36px" }}>
            ...
            <p style={{ 
              ...
              We're Here to Help You Gear Up! Have questions about our products,
              your order, or planning your next adventure? Our team of outdoor
              enthusiasts is ready to guide you every step of the way.
            </p>
          </div>
            ...
            <button
              ...
              onMouseEnter={(e) => {
                if (!submitting) {
                  ...
                  e.target.style.boxShadow = "0 8px 20px rgba(123, 192, 67, 0.5)";
                }
              }}
              onMouseLeave={(e) => {
                if (!submitting) {
                  e.target.style.transform = "translateY(0)";
                  e.target.style.boxShadow = "0 6px 16px rgba(123, 192, 67, 0.4)";
                }
              }}
            >
        ...
        >
          <div style={{ marginBottom: "32px" }}>
            ...
            <p style={{ 
              ...
              Come visit or connect with us! We're always excited to meet fellow adventurers — whether
              you're stopping by in person or reaching out from the wild. Here's how you can get in
              touch:
            </p>
          </div>
          ...
          <div style={{ color: "#374151" }}>
            ...
            >
              <p style={{ margin: 0, fontWeight: "500" }}>35T, First Floor, Liberty Plaza, Colombo - 03</p>
            </ContactRow>
            ...
            >
              <p style={{ margin: 0, fontWeight: "500" }}>+94 764078448 / +94 705702579</p>
            </ContactRow>
            ...
            >
              <p style={{ margin: 0, fontWeight: "500" }}>Sinthass@outlook.com</p>
            </ContactRow>
            ...
            >
              <p style={{ margin: 0, fontWeight: "500" }}>Monday - Saturday : 10.00AM – 07.00PM</p>
            </ContactRow>
          </div>
        </div>
      </div>
