...
const Login = () => {
  ...
  // Google sign-in method - FIXED VERSION (using the working approach from register)
  ...
  const handleInputChange = (e) => {
    ...
    if (formErrors.general || reduxError) {
  ...
  // Combine errors
  const displayError = formErrors.general || reduxError;
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-green-50 p-4 lg:p-8">
      <div className="w-full max-w-6xl flex flex-col lg:flex-row rounded-2xl lg:rounded-3xl shadow-2xl overflow-hidden bg-white">
          ...
          <div className="w-full max-w-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-6" noValidate>
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <button
                    ...
                    className="text-sm font-medium text-[#8DC53E] hover:text-[#7AB535] transition-colors duration-200 focus:outline-none focus:underline"
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full py-4 px-6 bg-[#8DC53E] hover:bg-[#7AB535] disabled:bg-[#C4E394] text-white font-semibold rounded-lg shadow-lg transition-all duration-200 transform hover:scale-105 disabled:scale-100 disabled:cursor-not-allowed focus:outline-none focus:ring-4 focus:ring-[#E6F2D8]"
        ...
        {/* Right Side - Image */}
        <div className="w-full lg:w-1/2 relative overflow-hidden order-first lg:order-last">
          <div className="relative h-64 lg:h-full min-h-[400px]">
            ...
            <div className="absolute bottom-6 left-6 right-6 lg:hidden">
              ...
              <p className="text-white/90 text-sm">
                Explore the great outdoors with premium gear and equipment
              </p>
            </div>
          </div>
        </div>
