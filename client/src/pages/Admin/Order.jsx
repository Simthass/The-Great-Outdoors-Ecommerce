...
<<<<<<< HEAD
  ...
  const inventoryItems = [
    { name: "ElkHorn Compound Bow Set", quantity: 3, price: 20, actions: "Edit" },
    { name: "Hawksbill Long Bow Set", quantity: 1, price: 15, actions: "Edit" },
    { name: "Sentinel Recurve Bow Set", quantity: 4, price: 25, actions: "Edit" },
    { name: "Upland Compound Bow Set", quantity: 2, price: 30, actions: "Edit" },
    { name: "Coleman Sundome Tents", quantity: 10, price: 30, actions: "Edit" },
    { name: "Decathlon Quechua 2 Seconds Easy 3-person Tent", quantity: 9, price: 30, actions: "Edit" },
