...
const Order = () => {
  ...
  const fetchOrders = async () => {
    try {
      ...
      const response = await axios.get(
        `http://localhost:5000/api/orders?${queryParams.toString()}`,
        {
  ...
  const fetchPaymentReport = async () => {
    try {
      const response = await axios.get(
        "http://localhost:5000/api/orders/admin/payment-report",
        {
          withCredentials: true,
        }
      );
      ...
      <Row className="mb-4">
        <Col>
          ...
          <p className="text-muted">
            Manage customer orders, track payments, and generate reports
          </p>
        </Col>
      </Row>
            ...
            <div>
              ...
              <Row className="mb-3">
                ...
                <Col md={4}>
                  ...
                  <br />
                  <Badge
                    bg={getPaymentStatusBadge(selectedOrder.paymentStatus)}
                  >
