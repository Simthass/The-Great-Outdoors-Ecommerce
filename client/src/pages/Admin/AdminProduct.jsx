...
const AdminProduct = () => {
  ...
  const refreshInventoryStatus = async () => {
    try {
      ...
      setError("Failed to refresh inventory status");
    }
  };
  ...
  // Add inventory linking functionality to the form
  const handleInputChange = (e) => {
    ...
    if (type === "checkbox") {
      ...
      // Handle multiple file uploads (existing code)
      ...
      // NEW: Auto-populate name and price when inventory is selected
      if (value) {
        ...
        if (selectedInventory) {
          setFormData((prev) => ({
            ...
            price: selectedInventory.price.toString(),
          }));
        } else {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Append all form fields including inventory
      Object.keys(formData).forEach((key) => {
        if (key === "images") {
          ...
          // Make sure inventory is included
          if (formData[key]) {
                      ...
                      <div className="p-4">
                        ...
                        <div className="flex gap-2">
                          <button
                            ...
                            className="flex-1 hover: bg-green-600 hover:bg-[#76A337] text-white py-2 px-3 rounded-md text-sm font-medium transition-colors flex items-center justify-center"
                          >
                            <svg
                        ...
                        <div className="bg-gray-50 p-6 rounded-lg">
                          ...
                          <div className="mb-6">
                              ...
                              {inventoryItems.map((item) => {
                                ...
                                return (
                                  <option
                                    key={item._id}
                                    value={item._id}
                                    title={`${item.name} (Qty: ${item.quantity}, Price: Rs.${item.price})`}
                                  >
                                    {truncatedName} (Qty: {item.quantity},
                                    Price: Rs.{item.price})
                                  </option>
                                );
                              })}
                            ...
                            <p className="text-xs text-gray-500 mt-2">
                              Link this product to an inventory item to
                              automatically track stock levels.
                              <span className="font-medium text-blue-600">
                                {" "}
                                Product name and price will be auto-filled when
                                selected.
                              </span>
                            </p>
                          </div>
                              ...
                              <div className="relative">
                                <label className="flex items-center cursor-pointer group">
                                  ...
                                  <div className="ml-3">
                                    ...
                                    <p className="text-xs text-gray-500 mt-1">
                                      Highlight as trending product this week
                                    </p>
                                  </div>
                                </label>
                              </div>
                              ...
                              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                                ...
                                {imagePreviews.map((preview, index) => (
                                  ...
                                  >
                                    ...
                                    <div className="absolute bottom-0 left-0 right-0 bg-green-600 text-white text-xs p-1 rounded-b-lg">
                                      New
                                    </div>
                                  </div>
                                ))}
